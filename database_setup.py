...
class ProductStatusMaster(Base):
    ...
    status = Column(Enum('Idle', 'OnGoing','Finished'), nullable=False, default='Idle')
...
class LoginHistory(Base):
    ...
    login_time = Column(DateTime(timezone=False), server_default=func.now())
...
class Board(Base):
    ...
    created_date = Column(DateTime(timezone=False), server_default=func.now())
    updated_date = Column(DateTime(timezone=False), onupdate=func.now())
